	...
	return {
      ...
      */
		...
		optimization: {
			...
			*/
			// include the runtime chunk for library builds
			runtimeChunk: false,
		},
		/*
		 */
		...
		resolve: {
			...
			alias: {
				...
				"@": paths.appSrc, // path.resolve(dirname, "src/"),
			},
			plugins: [
				...
				{ parser: { requireEnsure: false } },
				{
					...
					oneOf: [
						...
						// The preset includes JSX, Flow, TypeScript, and some ESnext features.
						{
							...
							// exclude: /\.(spec|test)\.(js|mjs|jsx|ts|tsx)$/,
		...
		plugins: [
			...
			// TODO: generate a .js file instead to load within dojo amd
			/*
